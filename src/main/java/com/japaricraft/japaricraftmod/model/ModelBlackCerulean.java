...
public class ModelBlackCerulean extends ModelBase {
    ...
    public ModelBlackCerulean() {
        ...
        this.eye.setRotationPoint(0.0F, -21.5F, -30.2F);
        ...
        this.mainBody.addChild(this.eye);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (entity != null) {
            ...
            if (d0 > 0.0D) {
                this.eye.rotationPointY = -21.5F;
            } else {
                this.eye.rotationPointY = -20.5F;
            }
