...
import com.japaricraft.japaricraftmod.block.fluid.BlockSandStarWater;
import com.japaricraft.japaricraftmod.block.fluid.SandStarWaterFluid;
...
public class JapariBlocks {
    public static Block sandstar_water;
    public static Fluid sandstar_water_fluid;
    ...
    {
        sandstar_water_fluid = SandStarWaterFluid.instance;
        FluidRegistry.addBucketForFluid(sandstar_water_fluid);
        sandstar_water = registerFluidBlock(sandstar_water_fluid, new BlockSandStarWater(sandstar_water_fluid), "sandstar");
