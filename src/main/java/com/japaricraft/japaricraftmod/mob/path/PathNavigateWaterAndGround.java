package com.japaricraft.japaricraftmod.mob.path;
...
public class PathNavigateWaterAndGround extends PathNavigate {

    public PathNavigateWaterAndGround(EntityLiving entitylivingIn, World worldIn) {
