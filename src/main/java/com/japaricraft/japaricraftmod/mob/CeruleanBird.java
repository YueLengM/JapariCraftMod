...
public class CeruleanBird extends EntityFlying implements IMob {
    ...
    class BirdMoveHelper extends EntityMoveHelper {
    ...
    public boolean getCanSpawnHere() {
        ...
        return block instanceof BlockLeaves || block == Blocks.GRASS || block == Blocks.AIR && super.getCanSpawnHere();
    }
