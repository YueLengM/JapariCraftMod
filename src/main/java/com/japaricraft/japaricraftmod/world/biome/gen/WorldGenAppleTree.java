package com.japaricraft.japaricraftmod.world.biome.gen;
...
public class WorldGenAppleTree extends WorldGenAbstractTree {
    ...
    public WorldGenAppleTree(int minTreeHeight, IBlockState metaWood, IBlockState metaLeaves, boolean doVinesGrow, IBlockState fruitType) {
        super(true);
