...
public class JapariEntityRegistry {
    public static void registerEntities() {
        ...
        EntityRegistry.registerModEntity(new ResourceLocation(JapariCraftMod.MODID, "royalpenguin"), RoyalPenguinEntity.class, prefix("RoyalPenguin"), 11, JapariCraftMod.instance, 70, 3, false, 2243405, 7375001);
        EntityRegistry.registerModEntity(new ResourceLocation(JapariCraftMod.MODID, "alpaca"), EntityAlpaca.class, prefix("Alpaca"), 12, JapariCraftMod.instance, 70, 3, false, 0xf0f5f0, 0xf5f5dc);
        EntityRegistry.registerModEntity(new ResourceLocation(JapariCraftMod.MODID, "squirre"), EntitySquirre.class, prefix("Squirre"), 13, JapariCraftMod.instance, 70, 3, false, 0xf0f5f0, 0x993300);
