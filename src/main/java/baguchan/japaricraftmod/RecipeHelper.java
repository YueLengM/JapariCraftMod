...
public class RecipeHelper {
    ...
    {
        return recipe.setRegistryName(new ResourceLocation(MODID, name));
    }

    public static IRecipe getShapedRecipe(String group, String name, ItemStack result, Object... recipe)
    {
        return new ShapedOreRecipe(new ResourceLocation(MODID, group), result, recipe).setRegistryName(MODID, name);
    }
    ...
    {
        return new ShapelessOreRecipe(new ResourceLocation(MODID, group), result, recipe).setRegistryName(MODID, name);
    }
