...
public class EntityAIWaterFollowOwner extends EntityAIBase {
    ...
    public EntityAIWaterFollowOwner(EntityTameable tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
